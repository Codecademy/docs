...
Conjecture is used to construct a mathematical proof. Conjecture can be thought of as a building block of a hypothesis that can be validated using logic and patterns.

Mathematical exploration and discovery heavily depend on the implementation of conjecture.

## Base Case

Base case is termed as the initial or smallest value that verifies a statement to be correct. According to Principle of Mathematical Induction, a proof is bifurcated into two steps:
