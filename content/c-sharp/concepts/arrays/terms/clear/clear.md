...
`.Clear()` is a static method of the `Array` class. Used with just an array as an argument, it clears the whole array. It can also be called with an array, a start index, and a number, to clear that number of elements starting at index.
