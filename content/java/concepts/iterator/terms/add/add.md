...
The `.add()` method removes an item from the underlying collection of a `ListIterator` object. This method adds the item before the next element that would be returned by the [`.next()`](https://www.codecademy.com/resources/docs/java/iterator/next) method.
