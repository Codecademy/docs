...
The **Comparator** interface is used to order objects of an arbitrary class. It is not to be confused with the [Comparable](https://www.codecademy.com/resources/docs/java/comparable) interface, which is implemented by the class to be sorted. The Comparator interface is implemented in a separate class.
