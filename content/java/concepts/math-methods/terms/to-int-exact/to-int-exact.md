---
Title: '.toIntExact()'
Description: 'Returns the integer value of a long type argument. Exception is thrown if the value of argument overflows that of an int.'
Subjects:
  - 'Computer Science'
Tags:
  - 'Arithmetic'
...
The **`Math.toIntExact()`** method returns the integer value of a long type argument. Exception is thrown if the value of argument overflows that of an int.
