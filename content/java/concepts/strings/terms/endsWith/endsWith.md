...
The **`.endsWith()`** method returns a boolean value based on if a string ends with a given suffix. If the **string ends with the given suffix it will return true otherwise it will return false**.
