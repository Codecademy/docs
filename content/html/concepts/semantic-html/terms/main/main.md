  ...
  <body>
    ...
    <main>
      ...
      <ul>
        ...
        <li>"Shall I compare thee to a summer’s day? Thou art more lovely and more temperate." - Sonnet 18</li>
      </ul>
    </main>
    <footer>
      <a href="https://en.wikipedia.org/wiki/William_Shakespeare">Learn more about William Shakespeare</a>
    </footer>
  </body>
</html>
```