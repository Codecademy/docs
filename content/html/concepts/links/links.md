...
![Hyperlink](../../../../media/hyperlinkexample.png)
...
```
![Codecademy](../../../../media/codecademy.png)
...
```
![CodecademyLogo](../../../../media/codecademylogo.png)
...
The [`<link>`](https://www.codecademy.com/resources/docs/html/elements/link) ![Link](../../../../media/link.png) element is used to connect the document to an outside resource, most commonly stylesheets, via the [`<head>`](https://www.codecademy.com/resources/docs/html/elements/head)
 ![Head](../../../../media/head.png) element. Unlike most elements, which come as opening and closing tags, the `<link />` is self-closing and only contains attributes.
