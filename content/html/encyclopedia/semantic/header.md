...
Before the main content is shown to the users of Bongo Ltd., they should see the company logo, a form which allows them to search the site, and a few links to common pages across the site. This is a great use for the header semantic tag, sketched out below:
