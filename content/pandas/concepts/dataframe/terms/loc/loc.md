...
The `.loc` property of the `DataFrame` object allows the return of specified rows and/or columns from that `DataFrame`. It can do so using a label or labe(s), or a boolean array of the same size as the axis being filtered.
