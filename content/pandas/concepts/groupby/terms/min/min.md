---
Title: '.min()'
Description: 'Produces a result with minimum values for the groups in a GroupBy object.'
Subjects:
  - 'Computer Science'
  - 'Data Science'
Tags:
...
The `.min()` method produces a result with minimum values for the groups in a [GroupBy](https://www.codecademy.com/resources/docs/pandas/groupby) object.
