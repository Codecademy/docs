---
Title: '.mean()'
Description: 'Produces a result with aggregate mean values for the groups in a GroupBy object.'
Subjects:
  - 'Computer Science'
  - 'Data Science'
Tags:
...
The `.mean()` method produces a result with aggregate mean values for the groups in a [GroupBy](https://www.codecademy.com/resources/docs/pandas/groupby) object.
