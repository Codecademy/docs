...
The **`.top()`** method returns the top element on the [`stack`](https://www.codecademy.com/resources/docs/cpp/stacks). This will be the most recently added element on the `stack`.
