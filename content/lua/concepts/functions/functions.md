...
Description: 'Functions are blocks of code that can be repeated multiple times. They can perform specific tasks when they’re called.' # Required; ideally under 150 characters and starts with a noun (used in search engine results and content previews)
