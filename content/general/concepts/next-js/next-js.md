...
[Next.js](https://nextjs.org) is an open-source development framework that brings the best of React's client-side functionality to the server-side when building web applications.
