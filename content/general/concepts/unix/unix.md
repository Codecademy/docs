...
Originally developed for internal use at Bell labs, in the late 1970s AT&T licensed Unix to a variety of outside parties, leading to a number of academic and commercial Unix variants. These incude:

- BSD: From the University of Califorina, Berkley.
- SunOS/Solaris: From Sun Microsystems.
- AIX: From IBM

In 1991, [Linus Torvalds](https://www.codecademy.com/resources/docs/general/linus-torvalds) released the [open source](https://www.codecademy.com/resources/docs/general/open-source) [Linux](https://www.codecademy.com/resources/docs/general/linux) kernel as a Unix-like free alternative to propritary Unix systems. It had since exploded into dozens, if not hundreds of different variant distributions.
...
In 2000 Apple released a Unix System named Darwin that eventually became the core of the macOS operating system.

Unix and Unix-like operating systems are currently used widely on servers, workstations and mobile devices.
