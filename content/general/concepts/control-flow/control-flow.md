...
Conditional statements provide the ability to make decisions within a program based on certain conditions. They typically use [boolean expressions](https://www.codecademy.com/resources/docs/general/data-types/boolean)  expressions to determine whether a particular block of code should be executed or skipped. The most common conditional statements are:
