...
The origins of the iterative approach can be traced back to the 1950s and 1960s when software development was in its infancy. However, it was not until the 1980s that the iterative approach gained wider acceptance and became a popular methodology for software development. This was largely due to the emergence of object-oriented programming and the need for more flexible development processes that could adapt to changing requirements and customer feedback.
