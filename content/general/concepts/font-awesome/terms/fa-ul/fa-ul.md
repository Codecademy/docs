...
The **`fa-ul`** class is used with the [`fa-li`](https://www.codecademy.com/resources/docs/general/font-awesome/fa-li) class to create custom bullets in [unordered lists](https://www.codecademy.com/resources/docs/html/elements/ul).
