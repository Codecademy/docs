...
The **`getUTCMilliseconds`** method returns the milliseconds for the provided `Date` object, according to universal time (not be be confused with the `getMilliseconds` method).
