...
The example below defines a new array `groceries` and then lists, logs the 4 array items to the console. Next, to delete the last item in the array, its `length` property is set to 3. Finally, to confirm the last item has been removed, the updated array and the value of item 4 (`undefined`) are logged to the console.
...
console.log(`\n${groceries[3]}`); // Output: undefined; last item deleted
```
