...
```
## Removing Array
In Array you can remove the element. You can can delete or removing:
### 1. The first element of an Array using .shift() method
```js
const  fruit  =  ['Apple',  'Orange',  'Banana'];

const firstIdRemove = fruit.shift(); 

console.log(fruit); //['Orange', 'Banana']
```
### 2. The last element of an Array using .pop() method
```js
const  fruit  =  ['Apple',  'Orange',  'Banana'];

const firstIdRemove = fruit.pop(); 

console.log(fruit); //['Apple',  'Orange']
```
### 3. An element by Index
#### delete Operator
```js
const  fruit  =  ['Apple',  'Orange',  'Banana'];
