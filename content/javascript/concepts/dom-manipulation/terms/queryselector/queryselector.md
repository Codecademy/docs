...
![A tabbed interface where clicking different tabs updates the content and highlights the selected tab dynamically using querySelector](https://raw.githubusercontent.com/Codecademy/docs/main/media/querySelector_output3.png)
