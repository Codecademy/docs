---
Title: '.hasOwn()'
Description: 'Return a boolean value indicating whether the object possesses the specified property as its own—return true if it exists, false if it's inherited or non-existent.'
Subjects:
  - 'Web Development'
  - 'Code Foundations'
Tags:
