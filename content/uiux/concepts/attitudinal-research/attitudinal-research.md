---
Title: 'Attitudinal Research' # Required; the file name should be the same as the title, but lowercase, with dashes instead of spaces, and all punctuation removed
Description: 'Attitudinal research methods focus on self-reported thoughts, beliefs, and needs from users, or put simply, what users say, rather than what they do.' # Required; ideally under 150 characters and starts with a present-tense verb (used in search engine results and content previews)
