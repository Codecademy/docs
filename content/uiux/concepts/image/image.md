...
For digital images, the most common file types are raster and vector. A **raster file** is made up of pixels and often uses the extension JPEG or PNG. While a raster file can be resized, as the image increases in size, it will lose quality and become blurry. In contrast, a **vector file** is made up of equations that capture the shapes, colors, and properties of the image. Because a vector file uses equations instead of pixels, the image can be resized without compromising quality. Vector files are often saved with the extension SVG. Each file type has advantages and disadvantages, as discussed in [this article from Adobe XD](https://www.adobe.com/creativecloud/file-types/image/comparison/raster-vs-vector.html).
