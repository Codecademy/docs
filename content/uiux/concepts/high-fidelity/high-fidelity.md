---
Title: 'High-fidelity' # Required; the file name should be the same as the title, but lowercase, with dashes instead of spaces, and all punctuation removed
Description: 'High-fidelity refers to design deliverables that are realistic and near final-product quality.' # Required; ideally under 150 characters and starts with a present-tense verb (used in search engine results and content previews)
