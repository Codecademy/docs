...
Description: 'An _X coordinate_ and a _Y coordinate_ indicate the location of a point along an X-axis (horizontal) and a Y-axis (vertical).' # Required; ideally under 150 characters and starts with a present-tense verb (used in search engine results and content previews)
...
An _X coordinate_ and a _Y coordinate_ indicate the location of a point along an X-axis (horizontal) and a Y-axis (vertical). 
...
For further reading on X and Y coordinates in UI and UX design software, check out [Figma's article on alignment, rotation, and position](https://help.figma.com/hc/en-us/articles/360039956914-Adjust-alignment-rotation-and-position#Position).  