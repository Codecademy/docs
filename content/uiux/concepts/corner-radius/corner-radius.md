...
If the corner radius is zero, then there is no rounding, meaning that the corners are completely squared off. Increasing the value of the corner radius adds more rounding to the corners.
