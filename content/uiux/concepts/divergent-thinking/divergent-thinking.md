---
Title: 'Divergent Thinking' # Required; the file name should be the same as the title, but lowercase, with dashes instead of spaces, and all punctuation removed
Description: 'Divergent thinking is a creative mode of thinking that explores many possible solutions and generates novel ideas.' # Required; ideally under 150 characters and starts with a present-tense verb (used in search engine results and content previews)
...
_Divergent thinking_ is a creative mode of thinking that explores many possible solutions and generates novel ideas.
