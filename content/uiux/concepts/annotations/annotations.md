---
Title: 'Annotations' # Required; the file name should be the same as the title, but lowercase, with dashes instead of spaces, and all punctuation removed
Description: 'Annotations are often in the form of notes or comments that are included in design deliverables.' # Required; ideally under 150 characters and starts with a present-tense verb (used in search engine results and content previews)
