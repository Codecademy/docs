---
Title: 'Technical Capabilities' # Required; the file name should be the same as the title, but lowercase, with dashes instead of spaces, and all punctuation removed
Description: 'Technical capabilities refer to the limitations of what’s possible for a product development team.' # Required; ideally under 150 characters and starts with a present-tense verb (used in search engine results and content previews)
