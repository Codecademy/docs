---
Title: 'Information Architecture' # Required; the file name should be the same as the title, but lowercase, with dashes instead of spaces, and all punctuation removed
Description: 'Information architecture (IA) is the organization, prioritization, and presentation of information within a product, website, and other software applications.' # Required; ideally under 150 characters and starts with a present-tense verb (used in search engine results and content previews)
