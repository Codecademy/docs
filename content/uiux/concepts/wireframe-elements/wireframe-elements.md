---
Title: 'Wireframe Elements' # Required; the file name should be the same as the title, but lowercase, with dashes instead of spaces, and all punctuation removed
Description: 'A wireframe is constructed with simple, low-fidelity wireframe elements that can help communicate ideas during the wireframing process.' # Required; ideally under 150 characters and starts with a present-tense verb (used in search engine results and content previews)
...
A [wireframe](https://www.codecademy.com/resources/docs/uiux/wireframe) is constructed with simple, [low-fidelity](https://www.codecademy.com/resources/docs/uiux/low-fidelity) wireframe elements that can help communicate ideas during the wireframing process. 
