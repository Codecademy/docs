...
To get an animation to work, the animation must be bound to an element and the animation-duration must be defined. In this example code the `<h1>` elemenent will load as yellow and gradually change to orange over the course of 5 seconds.
