...
Flexbox is a layout model for creating increased flexibility in the arrangement and display of content within a container to better meet the demands of the modern web. Previously, the ways in which content could be specified within in a container was much more limited and brittle. With the popularity of mobile devices, web content must now adapt to accurately render across a much larger range of conditions.
