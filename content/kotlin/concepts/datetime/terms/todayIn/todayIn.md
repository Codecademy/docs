...
Description: 'Returns the current date at the given time zone, according to the operating system time.' # Required; ideally under 150 characters and starts with a present-tense verb (used in search engine results and content previews)
