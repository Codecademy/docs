...
| `height_ratios`  | array-like input of lenght nrows                                    | Sets the proportional height of rows, dividing the total height among them. If not provided, all rows have an equal height.                                                                                                          |
...
![Output](/media/matplotlib-subplots-example.png)
