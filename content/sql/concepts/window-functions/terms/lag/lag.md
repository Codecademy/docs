...
The output illustrates the results with a new column `previous_age` which now holds the value from the previous record. The first record is null because a default was not specified and previous row would be out of range.
