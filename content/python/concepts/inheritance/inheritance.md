...
**Inheritance** is an [object-oriented programming](https://www.codecademy.com/resources/docs/general/object-oriented-programming) concept where a class (often referred to as the child class) derives attributes and behaviors from another class (often referred to as the parent class).
