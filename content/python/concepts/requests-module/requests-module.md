...
Installing the `requests` module is done by running the following [pip](https://www.codecademy.com/resources/docs/python/pip) command in the [terminal](https://www.codecademy.com/resources/docs/general/terminal):
