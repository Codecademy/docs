...
> **Note**: Forking a repository is needed when the user lacks write access to the original repository or when the user wants to make changes without affecting the original. 
