...
The `.length` property can take different DataTypes for its key-value pairs as well.
...
The `.length` property will take in account any duplicate keys and will not include them.
