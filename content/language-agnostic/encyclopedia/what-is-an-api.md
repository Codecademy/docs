...
* Private APIs - Also known as Internal APIs are used primarily within a company to share resources and facilitate the business. (eg. Company Warehouse API for managing inventory with code). 

* Partner APIs - Rights or specific licenses are required for use. These APIs are popular in software-as-a-service platforms (eg. [AWS API](https://docs.aws.amazon.com/general/latest/gr/aws-apis.html)).
