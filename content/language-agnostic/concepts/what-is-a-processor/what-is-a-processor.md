...
Processors are comprised of components called transistors and capicitors. Transistors and capacitors are made of semiconductor material(silicon, germanium etc.) which amplify electic currents or turn them off based on the application instructions in the form of binary 1's and 0's being fed to the processor as machine code. 
