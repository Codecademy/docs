...
As a module bundler, Webpack can be used with *webpack.config.js* to generate dependency graphs, and define rules for tasks performed on a site. Primarily it is used to load, transform, and package modules for in-browser use.
